      ...
      <div className={classes.contactContent}>
        <div className={classes.container} style={{ marginTop: "80px" }}>
          ...
          <p>
            ...
            <br />
            <br />
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AI Start.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>Service</strong> refers to the Application And the Website.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>Website</strong> refers to AI Start, accessible from https://ai-st.art
            <br />
            <br />
          ...
          <p>
            To access your data, please send an email to info@ai-st.art. We’ll take steps to send your information as soon as is practicable.
            <br />
            <br />
          </p>
          <h2>Delete Your Data</h2>
          <p>
            To delete your data, please send an email to info@ai-st.art. We’ll take steps to delete your information as soon as is practicable.
            <br />
            <br />
          </p>
          <h2>Contact Us</h2>

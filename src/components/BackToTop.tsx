  ...
  return (
    <div className="fixed bottom-5 end-5 z-[40] flex flex-col items-center gap-1">
      <button
        ...
        className={`z-10 flex h-10 w-10 items-center justify-center rounded-full text-primary shadow-[inset_0px_0px_12px_0px] shadow-primary/40 backdrop-blur-3xl transition-all duration-500 ${scrollY < 72 && "translate-x-16"}`}
      >

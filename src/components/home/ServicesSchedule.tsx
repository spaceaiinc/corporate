        ...
        <div className="grid items-center gap-6 lg:grid-cols-2">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-base">
              With Schedule AI, you simply inputs your preferred dates and times
              via text or screenshot, and the system automatically
              cross-references with your opponent&apos;s Google Calendar to
              recommend optimal scheduling options.
            </p>
            <ul role="list" className="mt-6 text-sm text-default-700">
              <li className="flex items-center gap-2">
                <LuDot className="inline-block h-9 w-9 text-primary" />
                <span className="text-base font-medium">
                  Smart Schedule Recognition
                </span>
              </li>
              <li className="flex items-center gap-2">
                <LuDot className="inline-block h-9 w-9 text-primary" />
                <span className="text-base font-medium">
                  One-Click Confirmation with Automatic URL Generation
                </span>
              </li>
              <li className="flex items-center gap-2">
                <LuDot className="inline-block h-9 w-9 text-primary" />
                <span className="text-base font-medium">
                  Multiple Calendar Integration with Flexible Access Management
                </span>
              </li>
            </ul>

        ...
        <div className="grid items-center gap-6 lg:grid-cols-2">
          <div>
            ...
            <div className="group mt-5">
              <Link
                href=""
                className="inline-flex items-center justify-center gap-2 rounded-full px-4 py-2 text-sm text-primary transition-all duration-200 hover:bg-primary hover:text-white"
              >
                Read More

          ...
          <div className="p-6">
            <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                >
                  <span className="me-2 flex h-11 w-11 items-center justify-center rounded-full text-primary transition-all duration-300 group-hover:bg-white group-hover:text-black">

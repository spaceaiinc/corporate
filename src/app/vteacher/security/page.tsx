...
export const metadata: Metadata = {
  ...
  description: "Security Policy of V Teacher",
  icons: {
    icon: "/favicon.ico",
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-6 mt-20">
        ...
        <p className="mb-4">
          Security is one of our highest priorities because “V Teacher” handles
        ...
        <p className="mb-4">
          ...
          stored in “V Teacher” is set at the infrastructure level so that only
          the user himself/herself can view the data.
        </p>

        <h2 className="text-2xl font-semibold mb-2">Supabase Security</h2>
        <p className="mb-4">
          Supabase is trusted by thousands of developers for building and
          deploying secure applications. Key security features include:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
            **Multi-factor Authentication (MFA)**: Adds an extra layer of
            security by requiring a second factor to verify user identity.
          </li>
          <li>
          ...
          <li>
            **HIPAA Compliance**: Allows storing Protected Health Information
            (PHI) with a signed Business Associate Agreement (BAA).
          </li>
          <li>
          ...
          <li>
            **Backups and Recovery**: Daily backups with Point in Time Recovery
            for Pro Plan users.
          </li>
          <li>
        ...
        <p className="mb-4">
          Stripe is a PCI-certified Service Provider at Level 1, the most
          stringent certification level in the payments industry. Stripe’s
          security posture evolves continually to meet global financial industry
          standards. Features include:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
            **PCI Compliance**: Stripe is audited annually for PCI Service
            Provider Level 1 certification, covering Card Data Vault (CDV) and
            secure software development.
          </li>
          <li>
            **SOC Reports**: Stripe’s systems and processes comply with SOC 1
            and SOC 2 standards, with annual SOC 3 reports available.
          </li>
          <li>
            **Encryption**: All communications are encrypted using TLS, with
            AES-256 encryption at rest for sensitive data.
          </li>
          <li>
            **Access Control**: The Stripe Dashboard supports MFA, SAML 2.0
            single sign-on, and detailed role-based access to ensure least
            privilege.
          </li>
          <li>
            **Infrastructure Security**: Stripe infrastructure undergoes
            frequent penetration testing, red team exercises, and vulnerability
            scans to maintain resilience.
          </li>
        </ul>
        <p className="mb-4">
          For more details, visit{" "}
        ...
        <p className="mb-4">
          Vercel employs advanced security measures to ensure the protection of
          your data and compliance with industry standards:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
          ...
          <li>
            **GDPR Compliance**: Vercel adheres to GDPR requirements to ensure
            the protection of personal data for EU and UK users.
          </li>
          <li>
            **PCI DSS**: Vercel supports PCI DSS compliance for customers
            processing payment information.
          </li>
          <li>
            **HIPAA Compliance**: Vercel supports HIPAA compliance by
        ...
        <p className="mb-4">
          All communications with the “V Teacher” API and management screen are
